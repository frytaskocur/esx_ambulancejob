		...
		elseif data.current.value == 'ambulance_wear' then
			ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
				if skin.sex == 0 then
					...
					SetPedComponentVariation(ped, 3, 44, 0, 0) 
					SetPedComponentVariation(ped, 4, 96, 1, 0) -- spodnie
					SetPedComponentVariation(ped, 6, 61, 0, 0) -- buty
					SetPedComponentVariation(ped, 10, 57, 0, 0) -- detale
					SetPedComponentVariation(ped, 11, 249, 1, 0) -- torso
					SetPedComponentVariation(ped, 7, 126, 0, 0) -- łańcuch
					SetPedComponentVariation(ped, 8, 129, 0, 0) -- koszula
				else
